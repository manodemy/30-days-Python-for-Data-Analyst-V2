...
def generate_seeding_migration():
    nb_dir = Path('notebooks/excel')
    out_path = Path('supabase/migrations/044_seed_excel_notebooks.sql')
    ...
    for day in range(1, 13):
        ...
        full_title = f"Excel Day {day:02d}: {day_title}"
